...
- Mọi số liệu tính toán ở Mục 1.2 đã được cung cấp sẵn trong khối
  [CREDIT NEED CALCULATION] ở phần evidence. KHÔNG tự tính lại — chỉ ĐIỀN vào bảng.
...
#### CÁCH SỬ DỤNG DỮ LIỆU TỪ [CREDIT NEED CALCULATION]
- Bảng này đã được hệ thống TÍNH SẴN và đưa vào phần evidence dưới nhãn
  [CREDIT NEED CALCULATION]. Chép đúng các dòng và con số sang mục 1.2, GIỮ
  NGUYÊN cột "Nguồn". TUYỆT ĐỐI không tự tính lại, không làm tròn khác đi, không
  thêm bớt dòng.
- Cột "Nguồn" phải được nhắc lại trong phần bình luận khi bạn nói về
...
- Phần lớn dòng bảo lãnh và LC thường mang nguồn "mặc định" vì giấy đề nghị
  không có các mục này. Khi đó phần bình luận phải nêu rõ một câu rằng toàn bộ
...
- Mục 1.2: Tính toán nhu cầu cấp tín dụng ngắn hạn
    - a. Hạn mức vay ngắn hạn
        - ĐIỀN giá trị đã tính sẵn ở [CREDIT NEED CALCULATION] vào
